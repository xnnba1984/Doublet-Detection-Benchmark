...
# merge doublet scores of 2 batches
...
# random split into 6 batches, save to loom format
system.time({
  for(i in 1:length(data.chunk)){
    print(paste('===================', i))
    counts <- data.chunk[[i]]; dim(counts)
...
# split into 8 batches, save to loom format
system.time({
  for(i in 1:length(data.chunk)){
    print(paste('===================', i))
    counts <- data.chunk[[i]]; dim(counts)
...
# random split into 10 batches, save to loom format
system.time({
  for(i in 1:length(data.chunk)){
    print(paste('===================', i))
    counts <- data.chunk[[i]]; dim(counts)
