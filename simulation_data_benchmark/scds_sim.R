...
# save the result, change the file name based on which experimental condition or method we use
...
score.list <- readRDS('paper_result/bcds_rate.rds')[[3]]
