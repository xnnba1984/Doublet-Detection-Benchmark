...
saveRDS(result, "paper_result/doubletdetection_cluster_dbscan_8.rds")

#############################################################
# cluster quality
#############################################################
result <- readRDS("paper_result/doubletdetection_cluster_dbscan_8.rds")
cluster <- 8
...
saveRDS(error, "paper_result/doubletdetection_purity_dbscan_8.rds")
