...
###########################################################
score.list <- readRDS("paper_result/doubletdetection_type.rds")
...
ggplot(result, aes(x=pred.num, y=cluster)) + geom_line() + xlab('Doublets Prediction Number') + ylab('Cluster Number') + 
  ggtitle('Cluster Number over Doublets Prediction Number - doubletdetection')
saveRDS(result, "paper_result/doubletdetection_cluster_8.rds")


#############################################################
# cluster quality
#############################################################
result <- readRDS("paper_result/doubletdetection_cluster_8.rds")
cluster <- 8
...
saveRDS(error, "paper_result/doubletdetection_purity_8.rds")
