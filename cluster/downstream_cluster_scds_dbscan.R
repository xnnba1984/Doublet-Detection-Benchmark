...
###########################################################
score.list <- readRDS("paper_result/bcds_type.rds")
...
saveRDS(result, "paper_result/bcds_cluster_dbscan_8.rds")

#############################################################
# cluster quality
#############################################################
result <- readRDS("paper_result/bcds_cluster_dbscan_8.rds")
cluster <- 8
...
saveRDS(error, "paper_result/bcds_purity_dbscan_8.rds")
