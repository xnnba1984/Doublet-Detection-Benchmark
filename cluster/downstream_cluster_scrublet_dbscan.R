...
saveRDS(result, "paper_result/scrublet_cluster_dbscan_8.rds")

#############################################################
# cluster quality
#############################################################
result <- readRDS("paper_result/scrublet_cluster_dbscan_8.rds")
cluster <- 8
...
saveRDS(error, "paper_result/scrublet_purity_dbscan_8.rds")
