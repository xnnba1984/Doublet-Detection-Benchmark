...
saveRDS(result, "paper_result/dblcells_cluster_dbscan_8.rds")

##########################################################################################################################
# proportion of singlets in correctly identified clusters (cluster quality)
##########################################################################################################################
# 4, 6, 8 clusters
result <- readRDS("paper_result/dblcells_cluster_dbscan_8.rds")
cluster <- 8
...
saveRDS(error, "paper_result/dblcells_purity_dbscan_8.rds")
