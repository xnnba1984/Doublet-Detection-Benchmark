...
palette(c("red","grey"))
#png(filename="figure/psudaotime_dblcells_clean.png")
pdf('paper_figure/psudotime_dblcells_splingshot.pdf')
plot(pca$PC1, pca$PC2, col = pca$type, pch=16, asp = 0, main='dblCells', xlab='PC1', ylab='PC2')
